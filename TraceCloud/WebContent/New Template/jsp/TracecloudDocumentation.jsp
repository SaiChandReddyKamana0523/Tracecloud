...
<title>Tracecloud Features</title>
 <script src="https://kit.fontawesome.com/e37f5abc40.js" crossorigin="anonymous"></script>
      ...
      <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/TracecloudDocumentation.css" />
       <script type="text/javascript" src="${pageContext.request.contextPath}/js/TracecloudDocumentation.js"></script>
