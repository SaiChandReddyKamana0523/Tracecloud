...
<title>Tracecloud Login Page</title>
 <script src="https://kit.fontawesome.com/e37f5abc40.js" crossorigin="anonymous"></script>
      ...
      <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/TracecloudLoginPage.css" />
...
<body>
 <nav role="navigation" style="width: 100%;z-index: 999;background: white;border-bottom:1px solid #f3f3f3;padding-bottom: 10px;">
            ...
            <div class="col-md-12">
              ...
              <img src="${pageContext.request.contextPath}/Images/TracecloudLogo.png" style="float:inherit"/>
               ...
               <div id="menuToggle">
                     ...
                     <span style="margin-left: 200px; color: #232323;"></span>
                     <ul id="menu">
                        <li class="menu-list"><a href="${pageContext.request.contextPath}/jsp/TraceCloudHome.jsp"><i class="fa fa-home" aria-hidden="true"></i> &#160; Home</a></li>
  ...
  <div class="login-signup">
    Don't have an account? <a href="${pageContext.request.contextPath}/jsp/GetStarted.jsp">Sign Up</a>
  </div>
</div>
        </div>
    </div>
